...
class MCPClient:
    ...
    async def connect_to_server(self, server_script_path: str):
        ...
        #Lista de las herramientas disponibles
    ...
    async def process_query(self, query: str) -> str:
        ...
        #Procesar la respuesta y manejar las llamadas a la herramienta
        final_text = []
        ...
        for content in response.content:
            if content.type == 'text':
                ...
                #Ejecutar llamada a la herramienta
...
async def main():
    if len(sys.argv) < 2:
        print("Usage: python client.py C:\\Github\\MCP_Project\\weather\\weather.py")
        sys.exit(1)
